...
export interface AttendanceRecord {
  ...
  studentName: string;
  timestamp: string;
  status: 'presente' | 'tarde' | 'ausente' | 'salida';
  synced: boolean;
}
...
export interface WhatsappMessage {
  ...
  template: 'entrada_presente' | 'entrada_tardanza' | 'entrada_falta' | 'salida';
  status: 'en cola' | 'enviado' | 'fallido' | 'entregado';
  timestamp: string; // ISO date string
  statusMessage?: string; // e.g., error from provider
}
